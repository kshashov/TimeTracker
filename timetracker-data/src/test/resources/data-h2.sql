...
INSERT INTO users (id, name, email, week_start, validated) VALUES (1, 'user', 'user@mail.com', 1, true);
INSERT INTO projects (id, title, active) VALUES (1, 'project', true);
INSERT INTO actions (id, project_id, title, active) VALUES (0, 1, 'action', true);
