package com.github.kshashov.timetracker.web.mvc.components.navigation.bar;
...
import com.github.kshashov.timetracker.web.mvc.components.navigation.tab.NaviTab;
import com.github.kshashov.timetracker.web.mvc.components.navigation.tab.NaviTabs;
...
import com.github.kshashov.timetracker.web.mvc.views.Home;
...
@CssImport("frontend://styles/components/app-bar.css")
public class AppBar extends FlexBoxLayout {
    ...
    private void initContainer() {
        container = new FlexBoxLayout(menuIcon, contextIcon, this.title, search, actionItems);
    ...
    public void addRightCorner(Component component) {
    ...
    public Button addActionItem(VaadinIcon icon, String text) {
        Button button = UIUtils.createButton(text, icon, ButtonVariant.LUMO_SMALL,
                ButtonVariant.LUMO_TERTIARY);
        addActionItem(button);
        return button;
    }
