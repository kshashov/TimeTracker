package com.github.kshashov.timetracker.web.ui.components.navigation.bar;
...
import com.github.kshashov.timetracker.web.ui.components.navigation.tab.NaviTab;
...
public class AppBar extends FlexBoxLayout {
    ...
    private void initTabs(NaviTab... tabs) {
        ...
        addTab.addClickListener(e -> this.tabs
                .setSelectedTab(addClosableNaviTab("New Tab", HomePage.class)));
